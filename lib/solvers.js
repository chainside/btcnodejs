...
class P2pkSolver extends SingleSigSolver {
    constructor(privkey, sighash = new transaction.Sighash("ALL")) {
        super(sighash);
        this.privkey = privkey;
    }
...
class P2wpkhV0Solver extends P2pkhSolver {
    ...
    solve(digests) {
        const solveData = super.solve(digests);
...
class P2shSolver extends Solver {
...
class IfElseSolver extends Solver {
...
class TimlockSolver extends Solver {
...
class RelativeTimelockSolver extends TimlockSolver {
}
