...
class Address {
    ...
    toScript() {
        return this.type === "p2pkh" ? new scripts.P2pkhScript(this.hash) : new scripts.P2shScript(this.hash);
...
class SegwitAddress extends Address {
    ...
    toScript() {
        return this.type === "p2wsh" ? new scripts.P2wshV0Script(this.hash) : new scripts.P2wpkhV0Script(this.hash);
    }
}
